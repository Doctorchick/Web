...
class KuruganeApp {
        ...
        if (CONFIG.selections.propsCount) {
            summaryHTML += `
                <div class="summary-item">
                    ...
                    <div class="summary-value">${CONFIG.selections.propsCount} props</div>
                </div>
            `;
        }
    ...
    initMap() {
        ...
        const handleMouseMove = (e) => {
            ...
            const rect = carte.getBoundingClientRect();
            const x = e.clientX - rect.left - startX + 10; // +10 pour centrer
...
// Injection des styles de notification
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Effet de souris pour les cartes interactives
    document.addEventListener('mousemove', (e) => {
        const cards = document.querySelectorAll('.choice-card, .option-card, .props-choice-card, .option-rights-card');
        cards.forEach(card => {
...
// Amélioration des performances avec lazy loading pour les images
document.addEventListener('DOMContentLoaded', () => {
